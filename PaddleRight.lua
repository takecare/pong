...
function PaddleRight:init(width, height, xOffset, screenWidth, screenHeight, upKey, downKey)
    self.x = xOffset
...
function PaddleRight:collidesWith(ball)
    -- TODO
end

function PaddleRight:render()
...
function PaddleRight:handleInput()
...
function PaddleRight:_moveUpwards()
    self.dy = -self.speed
end

function PaddleRight:_moveDownwards()
    self.dy = self.speed
end

function PaddleRight:debug(x, y)
